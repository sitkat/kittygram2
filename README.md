...
| Путь | Описание |
|---|---|
| `/cats/` | `GET` доступен всем, `POST` только авторизованным; операции с конкретным котиком требуют аутентификацию |
| `/users/` | Список пользователей |
| `/achievements/` | CRUD для достижений |
| `/shelters/` | Список и создание приютов |
| `/shelters/{id}/` | Просмотр, изменение и удаление конкретного приюта |
| `/shelters/{id}/join/` | Вступление в приют как сотрудник |
| `/shelters/{id}/cats/` | Список котиков конкретного приюта |
| `/shelters/{id}/employees/` | Просмотр сотрудников приюта и добавление сотрудника |
| `/shelters/{shelter_pk}/staff/` | CRUD для записей сотрудников конкретного приюта |
